...
<script>
	function initMap(){var a={lat:lat,lng:lng},n=new google.maps.Map(document.getElementById("map"),{zoom:17,center:a});new google.maps.Marker({position:a,map:n})}var lat=59.927387,lng=30.345936;
</script>
